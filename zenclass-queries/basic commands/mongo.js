...
//exception
db.movies.find({},{_id:0, name: 1, rating: 1}).prettty()
...
db.movies.find({}, {_id: 0, name: 1}).sort({rating: 1}).pretty()

db.movies.find({}, {_id: 0, name: 1}).sort({rating: 1}).limit(2).pretty()

db.movies.find({}, {_id: 0, name: 1}).sort({rating: 1}).limit(2).skip(2).pretty()

db.movies.find({}, {_id:0, name: 1, rating: 1}).sort({rating:-1,name: 1}).pretty() - sortingalphabetic
